...
var favoriteFoods = ["food", "food", "food"];
...
// console.log("the length of the shapes array is " + daysOfTheWeek.length);

// TODO: console.log the length of the favoriteFoods array

// console.log("the length of the shapes array is " + favoriteFoods.length);
...
// for (var a = 0; i < daysOfTheWeek.length; i++) {
//     console.log(daysOfTheWeek[i]);
// }

// TODO: Using a for loop, iterate through the favoriteFoods array and console.log each favorite food

// for (var b = 0; i < favoriteFoods.length; i++) {
...
//     if (instructors[c] === "david" || instructors[c] === "sophie" || instructors[c] === "vivian") {
